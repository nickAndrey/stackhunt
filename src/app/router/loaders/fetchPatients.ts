    ...
    appointments: [
      {
        ...
        staff: {
          ...
          role: 'doctor',
          profile_image: 'https://example.com/staff/emily.jpg',
        },
      },
      {
        id: 'appt-002',
        ...
        duration_minutes: 15,
        location: 'Lab A',
        notes: 'Blood test for cholesterol and glucose levels.',
        status: 'scheduled',
        patient: {
          id: 'patient-002',
        ...
        staff: {
          id: 'staff-002',
          full_name: 'Nurse Jessica Brown',
          role: 'nurse',
          profile_image: 'https://example.com/staff/jessica.jpg',
        },
      },
      {
        id: 'appt-003',
        ...
        notes: 'Knee arthroscopy procedure.',
        status: 'scheduled',
        patient: {
          id: 'patient-001',
          full_name: 'Alice Johnson',
      ...
      },
      {
        ...
        staff: {
          id: 'staff-003',
          full_name: 'Dr. Ryan Smith',
          role: 'doctor',
          profile_image: 'https://example.com/staff/ryan.jpg',
        },
      },
    ],
